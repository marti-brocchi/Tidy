...
<html lang="it">
    ...
    <body>
        ...
        <?php 
              ...
              $stmt = mysqli_prepare($con, "SELECT * FROM prodotti WHERE cod = 'bundle'");
              ...
              if (mysqli_num_rows($res)==0) {
                  error_log($dateTime." -- Pagina Bundle -- Error: nessuna riga associata al codice\n", 3, $_SERVER["DOCUMENT_ROOT"]."../log.txt");
                  header("Location: ../Home/home.php");
                  exit();
              }
              if (mysqli_num_rows($res)>1) {
                  error_log($dateTime." -- Pagina Bundle -- Error: restituite più righe associate ad un codice\n", 3, $_SERVER["DOCUMENT_ROOT"]."../log.txt");
                  header("Location: ../Home/home.php");
                  exit();
              }
        ?>
