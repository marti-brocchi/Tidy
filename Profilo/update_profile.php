...
<?php 
    ...
    if($dataDiNascita == "") $dataDiNascita = NULL; // evita errori 

    // echo $firstname." - ".$lastname." - ".$dataDiNascita." - ".$telefono." - ".$stato." - ".$provincia." - ".$citta." - ".$indirizzo." - ".$cap." - ".$sesso; // DEBUG
    ...
    if (mysqli_stmt_affected_rows($stmt)!=1){
        error_log($dateTime." -- Profilo -- Error: update non eseguito - ".mysqli_error($con)."\n", 3, "../../log.txt");
        header("Location: ../Profilo/show_profile.php");
        exit();
    }
